    ...
    <div class="container">
      <div class="row align-items-center content-gap">
        ...
        <div class="col-lg-5">
          ...
          <div class="btn_wrapper">
            <a href="#" class="btn">Explore the System <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/button-arrow.svg"
                alt="button arrow"></a>
          </div>
          <!-- ICONS -->
          <div class="icons">
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card-box">
            ...
            <div class="btn_wrapper">
              <a href="#" class="btn">Start Reading <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/button-arrow.svg" alt="button arrow"></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card-box">
            ...
            <div class="btn_wrapper">
              <a href="#" class="btn">Join HumAIT <img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/button-arrow.svg" alt="button arrow"></a>
            </div>
          </div>
        </div>
