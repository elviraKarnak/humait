    ...
    <div class="container">
                ...
                <div class="btns d-flex justify-content-center align-items-center flex-column flex-md-row gap-3">
                    <?php if(!empty($homeBannerRightBtn)): ?>
                        <div class="btn_wrapper btn_wrapper2">
                            <a href="<?php echo $homeBannerRightBtn['url']; ?>" target='<?php echo $homeBannerRightBtn['target'] ? $homeBannerRightBtn['target'] : '_self'; ?>' class="btn btn2">
        ...
        <?php if(!empty($homeBannerBookImg)): ?>
            <div class="col-lg-5 text-end books">
                <img src="<?php echo $homeBannerBookImg['url']; ?>" 
                alt="<?php echo $homeBannerBookImg['alt']; ?>" 
